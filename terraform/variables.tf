...
variable "main_project"             { default = "func" }   # Set this VARIABLE - this will form  the name of RESOURCES
...
# variable "storage_account_access_key"   { default = "techslate-function-001" }